...
public final class Constants 
{
    ...
    public static class LocalizationConstants
    {
        ...
        public static final double blue_hub_y = 4.036;
        public static final double hub_z = 1.829;
        public static final Translation3d blue_hub = new Translation3d(blue_hub_x, blue_hub_y, hub_z);


        public static final double red_hub_x = 11.917;
        public static final double red_hub_y = 4.036;
        public static final Translation3d red_hub = new Translation3d(red_hub_x, red_hub_y, hub_z);
